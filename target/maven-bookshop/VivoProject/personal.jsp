    ...
    <div class="wrapper">
        <aside class="menu-bar">
            ...
            <dl id="j_MyCenterMenus" class="menu">
                ...
                <dd class="menu-item"><a href="${pageContext.request.contextPath}/settlementServlet?action=MyOrderTakeInformationTake&v_uid=${sessionScope.vivo_user.v_uid}">收货地址</a></dd>
...
<script>
    $(function () {
        $(".order-del").click(function () {
            ...
            window.location.href = "${pageContext.request.contextPath}/personalServlet?action=delOrder&v_uid=${sessionScope.vivo_user.v_uid}&v_myOrderNo=" + orderno;
